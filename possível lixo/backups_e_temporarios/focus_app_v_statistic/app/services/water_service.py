...
_POST_CYCLE_MESSAGES = [
    "Encha sua garrafa de água.",
    "Ande pela casa.",
    "Alongue-se.",
    "Olhe pela janela e descanse a vista.",
    "Levante-se por um minuto.",
]


def random_post_cycle_message() -> str:
    return random.choice(_POST_CYCLE_MESSAGES)
